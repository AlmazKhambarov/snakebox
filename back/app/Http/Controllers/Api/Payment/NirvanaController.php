...
class NirvanaController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $options = [
            ...
            'token'       => $method,
            'currency'    => 'RUB',
            'callbackUrl' => config('app.url') . '/api/payment/nirvana/callback?clientID=' . $transaction_id,
            'userInfo'    => [
        ...
        try {
            ...
            Log::channel('payment_nirvana')->info('Nirvana RUB response:', $responseData);

            if (($responseData['status'] ?? '') === 'ERROR') {
                Log::channel('payment_nirvana')->error('Nirvana RUB error:', $responseData);
    ...
    public function callback(Request $request)
    {
        ...
        try {
            ...
            Log::channel('payment_nirvana')->debug('Nirvana RUB callback:', $body);
            ...
            Log::channel('payment_nirvana')->error('Nirvana RUB callback exception: ' . $e->getMessage());
